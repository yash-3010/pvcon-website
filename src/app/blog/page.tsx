        ...
        {featuredPosts.length > 0 && (
          <section aria-labelledby="featured-heading" className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {featuredPosts[0] && (
                <article
                  aria-label={featuredPosts[0].title}
                  className="relative rounded-xl overflow-hidden h-72 md:h-full min-h-64"
                >
                  <Image
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <Link href={`/blog/${post.slug}`}>
                        <h3 className="text-sm font-semibold mt-1 leading-snug hover:text-primary transition-colors line-clamp-2">
                          {post.title}
                        </h3>
                      </Link>
                      <p className="text-xs text-foreground-accent mt-1">
              ...
              {recentPosts.map((post) => (
                <article key={post.slug} aria-label={post.title} className="group">
                  ...
                  <div>
                    {post.tags[0] && <TagPill tag={post.tags[0]} />}
                    <Link href={`/blog/${post.slug}`}>
                      <h3 className="text-sm font-semibold mt-1 leading-snug group-hover:text-primary transition-colors line-clamp-2">
                        {post.title}
                      </h3>
                    </Link>
                    <p className="text-xs text-foreground-accent mt-1">
