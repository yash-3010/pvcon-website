    ...
    return (
        <div className={clsx("w-full max-w-sm mx-auto rounded-2xl border lg:max-w-full transition-all", {
            ...
            <div className="p-6 mt-1">
                <p className={clsx("text-xs font-semibold uppercase tracking-wider mb-1", { "text-white/50": highlight, "text-foreground-accent": !highlight })}>Features</p>
                <p className={clsx("text-sm mb-5", { "text-white/60": highlight, "text-foreground-accent": !highlight })}>Everything included</p>
