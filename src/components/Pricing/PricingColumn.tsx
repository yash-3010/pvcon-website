...
const PricingColumn: React.FC<Props> = ({ tier, highlight, getStarted, features, featuresSubtext }) => {
  const { name, price, features: featureList } = tier;
  ...
  return (
    <div className={clsx("w-full max-w-sm mx-auto bg-white rounded-xl border border-gray-200 lg:max-w-full", { "shadow-lg": highlight })}>
      ...
      <div className="p-6 mt-1">
        ...
        <p className="text-foreground-accent mb-5">{featuresSubtext}</p>
